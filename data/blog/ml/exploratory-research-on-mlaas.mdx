...
While it is a thought-provoking discipline, MLOps needs [a whole book](https://www.goodreads.com/book/show/60715378-designing-machine-learning-systems?utm_medium=api&utm_source=author_widget) (maybe even several) to properly be explained, by industry professionals, not by an apprentice on a blog post 😜.
